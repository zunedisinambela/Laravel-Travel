        ...
        <div class="card-body">
            <form action="{{ route('travel-package.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="featured_event" autocomplete="off" placeholder="Featured Event"
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="departured_date" autocomplete="off" placeholder="Departured Date"
                        value={{ old('departured_date') }}>
                </div>
                <div class="form-group">
